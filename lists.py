...
#Start by turning this list of customer first names into a list called first_names. Make sure to enter the
#names in this order:
...
#Create a list called preferred_size. Fill our new list preferred_size with
#the following data, containing the preferred sizes for Ainsley, Ben, and Chani:
#["Small", "Large", "Medium"]
...
#Maria is having a hard time visualizing which customer is associated with each size.
...
#Create a two-dimensional list called customer_data using the following table as a reference
#for the data. Each sublist should contain a name, size, and expedited shipping option for a single person.
...
#Great job making it this far! One last thing, Maria received a new customer "Amit" and "Karim" that
# had the following data: [["Amit", "Large", True], ["Karim", "X-Large", False]]
#Create a new variable customer_data_final. Combine our existing list customer_data with our new customer 2d
# list using + by adding it to the end of customer_data.
